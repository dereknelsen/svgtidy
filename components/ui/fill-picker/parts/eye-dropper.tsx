...
export const EyeDropper = React.forwardRef<HTMLButtonElement, EyeDropperProps>(
  function EyeDropper({ className, ...rest }, ref) {
    ...
    return (
      <Button
        ...
        className={cn(
          "cursor-pointer",
          active &&
            "border-foreground/70 bg-foreground/10 text-foreground hover:bg-foreground/15",
          className,
        )}
        {...rest}
      >
