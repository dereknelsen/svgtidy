...
>(function FieldShell({ className, ...rest }, ref) {
  return (
    <div
      ref={ref}
      className={cn(
        "border-input flex h-8 items-stretch overflow-hidden rounded-md border bg-transparent font-mono text-xs shadow-xs",
...
export function FieldDivider() {
  return <div aria-hidden className="bg-border w-px self-stretch" />;
}
...
>(function FieldSuffix({ className, ...rest }, ref) {
  return (
    <span
      ...
      aria-hidden
      className={cn(
        "text-muted-foreground pointer-events-none pr-1.5",
        className,
      )}
      {...rest}
    />
