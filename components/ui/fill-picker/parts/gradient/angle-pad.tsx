  ...
  function AnglePad({ className, size = 32, ...rest }, ref) {
    ...
    return (
      <div
        ...
        className={cn(
          "border-border bg-muted focus-visible:ring-ring relative shrink-0 cursor-grab rounded-full border outline-none focus-visible:ring-2",
          className,
        )}
      ...
      >
        <div
          aria-hidden
          className="absolute top-1/2 left-1/2 size-0 origin-center"
          style={{ transform: `translate(-50%, -50%) rotate(${angle}deg)` }}
        >
          <div
            className="bg-foreground ring-background/40 absolute left-1/2 size-1.5 -translate-x-1/2 rounded-full shadow-sm ring-1"
