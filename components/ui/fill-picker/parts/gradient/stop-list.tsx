...
function StopRow({
  ...
  const swatch = (
    <button
      ...
      className="border-border hover:ring-ring focus-visible:ring-ring size-7 shrink-0 rounded-xs border transition-shadow outline-none hover:ring-2 focus-visible:ring-2"
    />
  );
  return (
    <div
      ...
      className={cn(
        "focus-visible:ring-ring flex cursor-pointer items-center gap-2 rounded-md border p-1 text-xs outline-none focus-visible:ring-2",
    ...
    >
      ...
      <button
        ...
        className="border-input text-muted-foreground hover:text-foreground inline-flex size-7 items-center justify-center rounded-md border shadow-xs disabled:opacity-30"
