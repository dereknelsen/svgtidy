  ...
  function PositionPad({ className, size = 32, ...rest }, ref) {
    ...
    return (
      <div
        ...
        className={cn(
          "border-border bg-muted focus-visible:ring-ring relative shrink-0 cursor-crosshair rounded-md border outline-none focus-visible:ring-2",
          className,
        )}
        {...rest}
      >
        ...
        <div
          aria-hidden
          className="border-background bg-foreground absolute size-2 -translate-x-1/2 -translate-y-1/2 rounded-full border"
