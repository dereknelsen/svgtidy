    ...
    case "hsl": {
      ...
      return [
        intChannel(
          "h",
          "H",
          round(stableFormatHue(toHsl, color, hsl?.h), 0),
          0,
          360,
        ),
    ...
    case "hsb": {
      ...
      return [
        intChannel(
          "h",
          "H",
          round(stableFormatHue(toHsv, color, hsv?.h), 0),
          0,
          360,
        ),
