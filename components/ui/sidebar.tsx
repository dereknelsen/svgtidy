...
function SidebarProvider({
  ...
  // Note: the stock component binds Cmd/Ctrl+B here. This app renders two
  // nested providers (files + inspector) which would both claim it, so the
  // shortcut wiring lives in hooks/use-app-hotkeys.ts instead.
