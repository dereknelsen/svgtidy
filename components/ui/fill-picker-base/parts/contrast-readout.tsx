      ...
      <ReadoutTooltip
        trigger={
          <button
            ...
            className={cn(
              CONTRAST_READOUT_CLASS,
              "hover:bg-muted/60 focus-visible:ring-ring cursor-pointer text-left focus-visible:ring-2 focus-visible:outline-none motion-safe:transition-colors",
              className,
            )}
            {...(rest as React.ButtonHTMLAttributes<HTMLButtonElement>)}
          >
            {readout.body}
            <span aria-hidden="true" className="text-muted-foreground ml-auto">
              ⇅
            </span>
    ...
    <ReadoutTooltip
      trigger={
        <div
          ...
          className={cn(
            CONTRAST_READOUT_CLASS,
            "focus-visible:ring-ring cursor-default outline-none focus-visible:ring-2",
            className,
          )}
          {...rest}
        >
