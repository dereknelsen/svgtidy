...
export const Alpha = React.forwardRef<HTMLDivElement, AlphaProps>(
  function Alpha({ orientation = "horizontal", className, ...rest }, ref) {
        ...
        >
          ...
          <Slider.Thumb
            ...
            className={cn(
              ...
              "has-[:focus-visible]:ring-ring has-[:focus-visible]:ring-offset-popover outline-none has-[:focus-visible]:ring-2 has-[:focus-visible]:ring-offset-2",
            )}
