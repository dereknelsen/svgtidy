      ...
      >
        <Select.Trigger
          ...
          className={cn(
            ...
            inline
              ...
              : "border-input focus-visible:border-ring focus-visible:ring-ring/50 h-8 w-full rounded-md border bg-transparent px-3 shadow-xs focus-visible:ring-[3px]",
            className,
          )}
        >
        ...
        <Select.Portal>
          <Select.Positioner sideOffset={4} className="z-50 outline-none">
            <Select.Popup
              className={cn(
                "border-border bg-popover text-popover-foreground min-w-[var(--anchor-width)] overflow-hidden rounded-md border p-1 shadow-md outline-none",
