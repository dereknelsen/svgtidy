      ...
      >
          ...
          {presets.map((p, i) => (
            <Radio.Root
              ...
              className={cn(
                ...
                "relative size-5 cursor-pointer rounded-sm transition-transform outline-none",
                "before:absolute before:-inset-1 before:content-['']",
                SAMPLE_EDGE,
                "focus-visible:ring-ring hover:scale-110 focus-visible:ring-2",
                "data-[checked]:ring-ring data-[checked]:ring-2",
              )}
              style={{
        ...
        {onAdd && (
          <button
            ...
            className={cn(
              "border-border text-muted-foreground relative inline-flex size-5 cursor-pointer items-center justify-center rounded-sm border border-dashed transition-colors outline-none",
              "before:absolute before:-inset-1 before:content-['']",
              "hover:border-foreground hover:text-foreground focus-visible:ring-ring focus-visible:ring-2",
            )}
          >
